...
//retrieve external deps
gulp.task('retrieve', ['bower-retrieve']);
...
// build styles to tmp
gulp.task('styles', ['clean', 'retrieve'], function () {
...
gulp.task('wiredep', ['retrieve'], function () {
...
gulp.task('bower-retrieve', ()=>{
  return bower();
});

// copy bower fonts
gulp.task('bower-fonts',['retrieve'], function () {
